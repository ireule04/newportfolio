document.addEventListener('DOMContentLoaded', function() {
    ...
    function showHackerPopup(id) {
        ...
        const lines = {
            '1': [{ el: document.getElementById('popup-1-line-1'), text: "Critical system breach detected. Memory address 0x00FF7A compromised." }, { el: document.getElementById('popup-1-line-2'), text: "> Kernel panic initiated." }],
            ...
            '3': [{ el: document.getElementById('popup-3-line-1'), text: "Extracting 1.2TB of encrypted data..." }, { el: document.getElementById('popup-3-line-2'), text: "> TRANSFER_COMPLETE" }]
        };
    ...
    document.getElementById('hacker-trigger')?.addEventListener('click', () => {
        if (docElement.classList.contains('hacker')) {
             ...
             if (!sessionStorage.getItem('3_shown')) popupTimeouts.push(setTimeout(() => showHackerPopup('hacker-popup-3'), 2500));
        }
    });
    ...
    form.addEventListener('submit', async (e) => {
        ...
        form.reset();
        setTimeout(() => { btn.classList.remove('success'); btnText.textContent = 'Send Message'; }, 3000);
    });
